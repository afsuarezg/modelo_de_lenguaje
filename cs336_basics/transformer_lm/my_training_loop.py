...
def parse_arguments():
    ...
    parser.add_argument("--residual_pdrop", type=float, default=0.25, help="Apply dropout to the output of each sub-layer, before it is added to the sub-layer input and normalized.")
    ...
    parser.add_argument("--precision", type=str, choices=["fp32", "fp16", "bf16"], default="fp32", help="Floating-point precision type.")
